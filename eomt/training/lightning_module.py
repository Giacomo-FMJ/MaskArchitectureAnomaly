    ...
    def __init__(
        ...
        if delta_weights and ckpt_path:
            ...
            if incompatible_keys.missing_keys:
                logging.warning(
                    f"Missing keys during loading (expected for anomaly_head): {incompatible_keys.missing_keys[:5]}...")
        else:
            logging.warning(
                "No checkpoint path provided (ckpt_path is None). Model initialized with random/default weights.")
